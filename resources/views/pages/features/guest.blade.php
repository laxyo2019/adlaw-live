    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3 mb-4">
                ...
                <p class="p-text">
                  {{str_limit('Search and find lawyer, law school or law firm near you, No matter where you are located or what legal issue you are facing or wanting practice with a top rated law school, you will find the right attorney in this legal platform.',$limit = 206, $end = '...')}}   
                </p>
                <a href="" class="btn btn-sm btn-info">More Info</a>
            </div>
            <div class="col-md-3 mb-4">
            ...
            <div class="col-md-3 mb-4">
                ...
                <p class="p-text">
                {{str_limit("After finding a relevant law firm, lawyer or law school user can book appointment accordingly and see the status of appointment whether it is confirmed pending or canceled. User can Schedule appointment by date and time and edit it.",$limit = 240, $end = '...')}}
                </p>
                <a href="" class="btn btn-sm btn-info">More Info</a>
            </div>
            <div class="col-md-3 mb-4">
