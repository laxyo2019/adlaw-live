			...
			<td class="col-md-6 col-xm-12 col-sm-12 " style="padding: 20px;">
					<div class="row mt-4 profile-div" >
						...
						<div class="col-md-9 col-xm-12 col-sm-12 ">
							<h3 class=" font-weight-bold"> {{$lawyer->name}}
								@if($lawyer->isOnline())
						...
						<div class="col-md-12">
								@if(Auth::user())
									...
									{{-- <span class="chat_icon  " style="font-size:16px;float:right;"></span> --}}
			                    
			                      	@else
			                      	<span class="chat_icon  " style="font-size:16px;float:right;"><a href="javascript:void(0)" onclick="loginChecked('{{ $lawyer->id }}')" style="text-decoration: none" ><i class="fa fa-envelope"></i> Message</a></span>
			                    @endif
						</div>
					</div>
					<div class="row">
						<div class="col-md-9 col-xm-12 col-sm-12">
							<div class="row">
							  	<div class="col-md-7 col-xm-12 col-sm-12 book">
							  		<a href="javascript:void(0)" class="btn btn-md text-success border-success bookBtn text-uppercase" id="{{$lawyer->id}}"> Book an Appointment</i></a>
							  	</div>
							  	@if($lawyer->user_catg_id ==2)
								   	<div class="col-md-5  col-xm-12 col-sm-12 viewP text-uppercase">
								   		<a href="{{ route('find_lawyer.show',[$lawyer->id])}}" class="btn btn-md text-primary border-primary">View Profile</i></a>
								   	</div>	
							   	@else
