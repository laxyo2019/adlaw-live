    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3 mb-4">
                ...
                <p class="p-text"> {{str_limit('Adlaw offers a complete case management solution for lawyers, law firms and corporate legal departments. This feature is stuffed with various sub-includes that empower you to accomplish more in less time',$limit = 210, $end = '...')}}
                </p>
            ...
            <div class="col-md-3 mb-4">
                ...
                <p class="p-text">
                {{str_limit('Any number of clients and their identifiable data can be added. Organize client information in a structured way. Effectively and precisely coordinate each legitimate case with a customer. Send emails and invoices to clients, add updates, make changes as and when needed to maintain the exactness of client data with Manage Adlaw.',$limit = 225, $end = '...')}}
                </p>
            ...
            <div class="col-md-3 mb-4">
                ...
                <p class="p-text">
                {{str_limit("Managing an organized law firm is challenging without visibility into your staff’s schedule. Adlaw helps you monitor what's going in your cases on one convenient, central calendar so nothing slips through the cracks.",$limit = 250, $end = '...')}}
                </p>
            ...
            <div class="col-md-3 mb-4">
                ...
                <p class="p-text">
                {{str_limit("It allows professionals to write the cases in word processing software and store the files with specifically labeled meta-data. With the adlaw Dropbox combination, you can exploit Dropbox's amazing highlights from directly within your adlaw account. To keep your records sorted out and in a state of sync, documents reports and envelopes added to a particular case organizer in Dropbox are promptly accessible inside the comparing case in adlaw.",$limit = 223, $end = '...')}}
                </p>
            ...
            <div class="col-md-3 mb-4">
                ...
                <p class="p-text">
                {{str_limit("Online appointment booking system make your life stress free by creating a platform through which your clients can schedule their appointments directly. Adlaw allows the appointment schedule management feature that is It, not only schedules your clients, but also helps you manage your schedules by adding new or edit existing date.",$limit = 210, $end = '...')}}
                </p>
            ...
            <div class="col-md-3 mb-4">
                ...
                <p class="p-text">
                {{str_limit("Agenda Management allows the lawyers/law firms to assign priorities, build momentum, collaborate without confusions and ensure that action steps are taken on time, every time. They are also essential to manage work overload effectively, helping you and your team members stay focused and organized.",$limit = 253, $end = '...')}}
                </p>
            ...
            <div class="col-md-3 mb-4">
                ...
                <p class="p-text">
                {{str_limit("Adlaw's team members management feature used to create new user, edit and delete user. Assign or create team of lawyer organize and keep track of cases assigned to each individual lawyer. It is a critical part of organizing and keeping track of cases assigned to each individual lawyer, See which groups team members are a part of, edit and delete profiles and Search for members by name, email address or mobile number.",$limit = 224, $end = '...')}}
                </p>
            ...
            <div class="col-md-3 mb-4">
                ...
                <p class="p-text">
                {{str_limit("Adlaw offers profile management in which lawyers can create their profile, update and delete the profile. The created lawyers profile will be shown in search box. With the help of this user can search the lawyer by name anywhere and get full profile details of lawyers.",$limit = 260, $end = '...')}}
                </p>
